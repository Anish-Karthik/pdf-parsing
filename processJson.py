...
def proccess(file):
    with open(file) as f:
        # json is type of ReadingComprehension
        json_data = json.load(f)
        # print(json_data)

        # create ReadingComprehension object
        ...
        for question in json_data['questions']:
            ...
            questions.append(Question(question['qno'], question['description'], options, question['correct_option'], question['detailed_answer']))
        reading_comprehension = ReadingComprehension(passage, questions, json_data['section'])


if __name__ == '__main__':
    proccess('output/barron-workbook-passage1.json')