...
if __name__ == '__main__':
    ...
    for paperNumber, file_name in enumerate(file_list, start=1):
        ...
        try:
            ...
            underlineObject.read_all_underline_sentences(file_name)
            write_text_to_file(all_text, "debug/file2.txt")
            ...
            continue
    saveDataFrame(finalDataFrame, f"output/SATPassages.xlsx")